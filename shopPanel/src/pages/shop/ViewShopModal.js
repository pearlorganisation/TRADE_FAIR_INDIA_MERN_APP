              ...
              <div className=" shadow-sm border rounded-lg overflow-x-auto p-3">
                <>
                  ...
                  <div className="w-full text-center border mx-auto p-6 border-b-transparent">
                   ...
                   <div>
                   {
                      Array.isArray(shopInfo?.events) && shopInfo?.events?.length > 0 ? <div className="space-y-3">
                        {
                          ...
                          >
                            <div className="p-2">
                              <div className="font-bold">Event {index+1}</div>
                            ...
                            <div className="grid grid-cols-2 p-2">
                              <div className="font-medium">Date of Event</div>
                              <div>
                               <span className="fw-bold">From</span> { new Date(`${item?.eventDate[0]}`).toISOString().split("T")[0]} - 
                  <span className="fw-bold"> To</span> : { new Date(`${item?.eventDate[1]}`).toISOString().split("T")[0]}
                      ...
                      </div> : <div className="w-full text-center">Currently this Shop doesn't associated with any Event.</div>
                    }
                   </div>
                  </div>
                </>
