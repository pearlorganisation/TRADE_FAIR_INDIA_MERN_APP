  ...
  return (
    <footer className="text-gray-500 bg-transparent px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        <div className="bg-clip-text text-transparent bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 text-2xl font-bold sm:text-3xl">
          Trade Fair India
        </div>
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0 bg-clip-text text-transparent bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500">
          &copy; 2023 Trade Fair India All rights reserved.
        </div>
