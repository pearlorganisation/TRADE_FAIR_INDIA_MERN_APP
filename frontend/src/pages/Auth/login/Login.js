      ...
      <div className="max-w-sm w-full text-gray-600 space-y-5">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-x-3">
              ...
              <label
                ...
                className="relative flex w-5 h-5 bg-white peer-checked:bg-[#00373E] rounded-md border ring-offset-2 ring-[#00373E] duration-150 peer-active:ring cursor-pointer after:absolute after:inset-x-0 after:top-[3px] after:m-auto after:w-1.5 after:h-2.5 after:border-r-2 after:border-b-2 after:border-white after:rotate-45"
              ></label>
          ...
          <button
            ...
            type="button"
            className="w-full px-4 py-2  font-medium text-[#00373E] hover:bg-black/10 rounded-lg duration-150"
          >
            Forget Password
          </button>
        </form>
